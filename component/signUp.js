...
return (
  <View style={styles.container}>
    ...
    <Pressable style={styles.bttn} onPress={()=>navigation.navigate("Login")}>
    ...
    <TouchableOpacity >
        <Text style={styles.account}>If you already Registered then?<Text style={styles.Registernow} onPress={()=>navigation.navigate("Login")}>Login here</Text></Text>
      </TouchableOpacity>
    </View>
  );
}
